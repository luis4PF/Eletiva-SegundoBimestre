  ...
  <form method="post">
    <div class="row">
      ...
      <div class="col">
        ...
        <input type="text" name="resultProduto1" value=KG/<?php echo $produto1; ?> 
            id="resultProduto1" class="form-control" />
      </div>
      <div class="col">
        <label for="resultFinal" class="label-control">
          VALOR FINAL:
        </label>
        <input type="text" name="resultFinal" value="R$<?php echo ($valor1 / $produto1); ?>" 
            id="resultFInal" class="form-control" />
      </div>
    </div>
  </form>
