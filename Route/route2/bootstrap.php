<?php
    ...
    $router->get('/exercicio2', 'Aluno\Luis4pf\Controller\ExercicioController::exibir');

    $router->post('/resultado2', 'Aluno\Luis4pf\Controller\ExercicioController::exibirResultado');
