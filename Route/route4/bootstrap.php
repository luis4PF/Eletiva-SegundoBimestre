<?php
    ...
    $router->get('/exercicio4', 'Aluno\Luis4pf\Controller\ExercicioController::exibir');

    $router->post('/resultado4', 'Aluno\Luis4pf\Controller\ExercicioController::exibirResultado');
