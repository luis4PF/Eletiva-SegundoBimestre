<?php
    ...
    $router->get('/exercicio5', 'Aluno\Luis4pf\Controller\ExercicioController::exibir');

    $router->post('/resultado5', 'Aluno\Luis4pf\Controller\ExercicioController::exibirResultado');
